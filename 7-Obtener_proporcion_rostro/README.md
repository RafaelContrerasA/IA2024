# Programa proporcion rostro

Programa que detecta rostros en la camara, los convierte en escala de grises, luego a blanco y negro y obtiene la proporcion que hay entre pixeles blancos y pixeles negros.
