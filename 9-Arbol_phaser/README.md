...
Se le integro a phaser una funcion al menu que al seleccionarlo genere el arbol de decision
...
def mostrar_menu():
    ...
    pantalla.fill(NEGRO)
    texto = fuente.render("Presiona 'A' para Auto, 'M' para Manual, G para graficar o , 'A' para arbol, 'Q' para Salir", True, BLANCO)
