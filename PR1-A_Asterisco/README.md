...
Este proyecto permite mediante la libreria pygames dibujar un laberinto, al cual posteriormente se analizara con el algoritmo A* para encontrar la ruta mas corta.
...
# Controlar delay
DELAY = 700  # Velocidad del recorrido
...
def reconstruir_camino(nodo_actual, dibujar):
    camino = []
    camino.append(nodo_actual.get_pos()) #Agregar el nodo final al camino, para mas estetica
